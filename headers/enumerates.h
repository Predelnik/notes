...
/**
 * @file headers/enumerates.h
 * @brief headers/enumerates.h
 *
...
typedef enum {
/** all non-unique weapons and armor have this code*/
	ITEM_CODE_NONE                        =  0,
/** unused*/
	ITEM_CODE_USE_FIRST                   =  1,
...
/** unused*/
	...
	ITEM_CODE_UNIQUE                      = 27,
/** unused*/
	ITEM_CODE_POTION_OF_HEALING_SOMETHING = 28,
...
/** used for Butcher's Cleaver*/
    ITEM_EFFECT_TYPE_CUSTOM_ATTACK_DAMAGE                   = 63,
    ITEM_EFFECT_TYPE_CUSTOM_DURABILITY                      = 64,
    ITEM_EFFECT_TYPE_NO_STRENGTH_REQUIREMENT                = 65,
/** (most likely erroneously) sets current spell charges to spell_id*/
    ITEM_EFFECT_TYPE_SET_SPELL_ID_AND_CHARGES               = 66,
...
/** in range 0-12.5%, used for The Undead Crown*/
    ITEM_EFFECT_TYPE_LIFE_STEAL_RANDOM                      = 73,
...
/** in range 0-12.5%*/
    ITEM_SPECIAL_EFFECT_LIFE_STEAL_RANDOM           = 2         ,
...
/** unused*/
    ITEM_SPECIAL_EFFECT_UNKNOWN_1                   = 0x80      ,
    ITEM_SPECIAL_EFFECT_USER_CANT_HEAL              = 0x100     ,
/** unused*/
    ITEM_SPECIAL_EFFECT_UNKNOWN_2                   = 0x200     ,
/** unused*/
    ITEM_SPECIAL_EFFECT_UNKNOWN_3                   = 0x400     ,
...
/** Suffix: Readiness*/
    ITEM_SPECIAL_EFFECT_QUICK_ATTACK                = 0x20000   ,
/** Suffix: Swiftness*/
    ITEM_SPECIAL_EFFECT_FAST_ATTACK                 = 0x40000   ,
/** Suffix: Speed*/
    ITEM_SPECIAL_EFFECT_FASTER_ATTACK               = 0x80000   ,
/** Suffix: Haste*/
    ITEM_SPECIAL_EFFECT_FASTEST_ATTACK              = 0x100000  ,
/** Suffix: Balance*/
    ITEM_SPECIAL_EFFECT_FAST_HIT_RECOVERY           = 0x200000  ,
/** Suffix: Stability*/
    ITEM_SPECIAL_EFFECT_FASTER_HIT_RECOVERY         = 0x400000  ,
/** Suffix: Harmony*/
    ITEM_SPECIAL_EFFECT_FASTEST_HIT_RECOVERY        = 0x800000  ,
...
/** cursed mana*/
    ITEM_SPECIAL_EFFECT_NO_MANA                     = 0x8000000 ,
    ITEM_SPECIAL_EFFECT_ABSORBS_HALF_OF_TRAP_DAMAGE = 0x10000000,
/** unused*/
    ITEM_SPECIAL_EFFECT_UNKNOWN_4                   = 0x20000000,
...
/** Item types.*/
typedef enum {
/** Potions, scrolls, books and quest items.*/
    ITEM_TYPE_MISC         =  0,
    ITEM_TYPE_SWORD        =  1,
    ITEM_TYPE_AXE          =  2,
    ITEM_TYPE_BOW          =  3,
...
typedef enum {
/** MONSTER_ID_FLESH_CLAN_MACE*/
    UNIQUE_MONSTER_ID_GHARBAD_THE_WEAK         =  0,
/** MONSTER_ID_SKELETON_KING*/
    UNIQUE_MONSTER_ID_SKELETON_KING            =  1,
/** MONSTER_ID_COUNSELOR*/
    UNIQUE_MONSTER_ID_ZHAR_THE_MAD             =  2,
/** MONSTER_ID_DARK_ONE_SPEAR*/
    UNIQUE_MONSTER_ID_SNOTSPILL                =  3,
/** MONSTER_ID_ADVOCATE*/
    UNIQUE_MONSTER_ID_ARCH_BISHOP_LAZARUS      =  4,
/** MONSTER_ID_HELL_SPAWN*/
    UNIQUE_MONSTER_ID_RED_VEX                  =  5,
/** MONSTER_ID_HELL_SPAWN*/
    UNIQUE_MONSTER_ID_BLACKJADE                =  6,
/** MONSTER_ID_BLOOD_KNIGHT*/
    UNIQUE_MONSTER_ID_LACHDANAN                =  7,
/** MONSTER_ID_STEEL_LORD*/
    UNIQUE_MONSTER_ID_WARLORD_OF_BLOOD         =  8,
/** MONSTER_ID_THE_BUTCHER*/
    UNIQUE_MONSTER_ID_THE_BUTCHER              =  9,
/** MONSTER_ID_CORPSE_AXE*/
    UNIQUE_MONSTER_ID_BONEHEAD_KEENAXE         = 10,
/** MONSTER_ID_FALLEN_ONE_SWORD*/
    UNIQUE_MONSTER_ID_BLADESKIN_THE_SLASHER    = 11,
/** MONSTER_ID_ZOMBIE*/
    UNIQUE_MONSTER_ID_SOULPUS                  = 12,
/** MONSTER_ID_FALLEN_ONE_SPEAR*/
    UNIQUE_MONSTER_ID_PUKERAT_THE_UNCLEAN      = 13,
/** MONSTER_ID_SKELETON_AXE*/
    UNIQUE_MONSTER_ID_BONERIPPER               = 14,
/** MONSTER_ID_ZOMBIE*/
    UNIQUE_MONSTER_ID_ROTFEAST_THE_HUNGRY      = 15,
/** MONSTER_ID_CARVER_SWORD*/
    UNIQUE_MONSTER_ID_GUTSHANK_THE_QUICK       = 16,
/** MONSTER_ID_CORPSE_CAPTAIN*/
    UNIQUE_MONSTER_ID_BROKENHEAD_BANGSHIELD    = 17,
/** MONSTER_ID_DEVIL_KIN_SPEAR*/
    UNIQUE_MONSTER_ID_BONGO                    = 18,
/** MONSTER_ID_GHOUL*/
    UNIQUE_MONSTER_ID_ROTCARNAGE               = 19,
/** MONSTER_ID_SCAVENGER*/
    UNIQUE_MONSTER_ID_SHADOWBITE               = 20,
/** MONSTER_ID_SKELETON_BOW*/
    UNIQUE_MONSTER_ID_DEADEYE                  = 21,
/** MONSTER_ID_BURNING_DEAD_AXE*/
    UNIQUE_MONSTER_ID_MADEYE_THE_DEAD          = 22,
/** MONSTER_ID_PLAGUE_EATER*/
    UNIQUE_MONSTER_ID_EL_CHUPACABRAS           = 23,
/** MONSTER_ID_CORPSE_BOW*/
    UNIQUE_MONSTER_ID_SKULLFIRE                = 24,
/** MONSTER_ID_HIDDEN*/
    UNIQUE_MONSTER_ID_WARPSKULL                = 25,
/** MONSTER_ID_ROTTING_CARCASS*/
    UNIQUE_MONSTER_ID_GORETONGUE               = 26,
/** MONSTER_ID_SHADOW_BEAST*/
    UNIQUE_MONSTER_ID_PULSECRAWLER             = 27,
/** MONSTER_ID_BLINK*/
    UNIQUE_MONSTER_ID_MOONBENDER               = 28,
/** MONSTER_ID_BLINK*/
    UNIQUE_MONSTER_ID_WRATHRAVEN               = 29,
/** MONSTER_ID_BONE_GASHER*/
    UNIQUE_MONSTER_ID_SPINEEATER               = 30,
/** MONSTER_ID_BURNING_DEAD_BOW*/
    UNIQUE_MONSTER_ID_BLACKASH_THE_BURNING     = 31,
/** MONSTER_ID_DARK_ONE_SWORD*/
    UNIQUE_MONSTER_ID_SHADOWCROW               = 32,
/** MONSTER_ID_LORD_SAYTER*/
    UNIQUE_MONSTER_ID_BLIGHTSTONE_THE_WEAK     = 33,
/** MONSTER_ID_OVERLORD*/
    UNIQUE_MONSTER_ID_BILEFROTH_THE_PIT_MASTER = 34,
/** MONSTER_ID_FLESH_CLAN_BOW*/
    UNIQUE_MONSTER_ID_BLOODSKIN_DARKBOW        = 35,
/** MONSTER_ID_GLOOM*/
    UNIQUE_MONSTER_ID_FOULWING                 = 36,
/** MONSTER_ID_HORROR_CAPTAIN*/
    UNIQUE_MONSTER_ID_SHADOWDRINKER            = 37,
/** MONSTER_ID_UNSEEN*/
    UNIQUE_MONSTER_ID_HAZESHIFTER              = 38,
/** MONSTER_ID_ACID_BEAST*/
    UNIQUE_MONSTER_ID_DEATHSPIT                = 39,
/** MONSTER_ID_FIRE_CLAN_MACE*/
    UNIQUE_MONSTER_ID_BLOODGUTTER              = 40,
/** MONSTER_ID_STONE_CLAN_MACE*/
    UNIQUE_MONSTER_ID_DEATHSHADE_FLESHMAUL     = 41,
/** MONSTER_ID_WYRM*/
    UNIQUE_MONSTER_ID_WARMAGGOT_THE_MAD        = 42,
/** MONSTER_ID_RED_STORM*/
    UNIQUE_MONSTER_ID_GLASSKULL_THE_JAGGED     = 43,
/** MONSTER_ID_FIRE_CLAN_BOW*/
    UNIQUE_MONSTER_ID_BLIGHTFIRE               = 44,
/** MONSTER_ID_GARGOYLE*/
    UNIQUE_MONSTER_ID_NIGHTWING_THE_COLD       = 45,
/** MONSTER_ID_NIGHT_CLAN_BOW*/
    UNIQUE_MONSTER_ID_GORESTONE                = 46,
/** MONSTER_ID_HELL_STONE*/
    UNIQUE_MONSTER_ID_BRONZEFIST_FIRESTONE     = 47,
/** MONSTER_ID_INCINERATOR*/
    UNIQUE_MONSTER_ID_WRATHFIRE_THE_DOOMED     = 48,
/** MONSTER_ID_MAGMA_DEMON*/
    UNIQUE_MONSTER_ID_FIREWOUND_THE_GRIM       = 49,
/** MONSTER_ID_MUD_MAN*/
    UNIQUE_MONSTER_ID_BARON_SLUDGE             = 50,
/** MONSTER_ID_NIGHT_CLAN_MACE*/
    UNIQUE_MONSTER_ID_BLIGHTHORN_STEELMACE     = 51,
/** MONSTER_ID_POISON_SPITTER*/
    UNIQUE_MONSTER_ID_CHAOSHOWLER              = 52,
/** MONSTER_ID_RED_DEATH*/
    UNIQUE_MONSTER_ID_DOOMGRIN_THE_ROTTING     = 53,
/** MONSTER_ID_FLAME_LORD*/
    UNIQUE_MONSTER_ID_MADBURNER                = 54,
/** MONSTER_ID_LITCH_DEMON*/
    UNIQUE_MONSTER_ID_BONESAW_THE_LITCH        = 55,
/** MONSTER_ID_MUD_RUNNER*/
    UNIQUE_MONSTER_ID_BREAKSPINE               = 56,
/** MONSTER_ID_RED_DEATH*/
    UNIQUE_MONSTER_ID_DEVILSKULL_SHARPBONE     = 57,
/** MONSTER_ID_RED_STORM*/
    UNIQUE_MONSTER_ID_BROKENSTORM              = 58,
/** MONSTER_ID_STORM_RIDER*/
    UNIQUE_MONSTER_ID_STORMBANE                = 59,
/** MONSTER_ID_TOAD_DEMON*/
    UNIQUE_MONSTER_ID_OOZEDROOL                = 60,
/** MONSTER_ID_BLOOD_CLAW*/
    UNIQUE_MONSTER_ID_GOLDBLIGHT_OF_THE_FLAME  = 61,
/** MONSTER_ID_OBSIDIAN_LORD*/
    UNIQUE_MONSTER_ID_BLACKSTORM               = 62,
/** MONSTER_ID_POISON_SPITTER*/
    UNIQUE_MONSTER_ID_PLAGUEWRATH              = 63,
/** MONSTER_ID_STORM_RIDER*/
    UNIQUE_MONSTER_ID_THE_FLAYER               = 64,
/** MONSTER_ID_FROST_CHARGER*/
    UNIQUE_MONSTER_ID_BLUEHORN                 = 65,
/** MONSTER_ID_HELL_BURNER*/
    UNIQUE_MONSTER_ID_WARPFIRE_HELLSPAWN       = 66,
/** MONSTER_ID_CAVE_VIPER*/
    UNIQUE_MONSTER_ID_FANGSPEIR                = 67,
/** MONSTER_ID_UNDEAD_BALROG*/
    UNIQUE_MONSTER_ID_FESTERSKULL              = 68,
/** MONSTER_ID_BLACK_KNIGHT*/
    UNIQUE_MONSTER_ID_LIONSKULL_THE_BENT       = 69,
/** MONSTER_ID_COUNSELOR*/
    UNIQUE_MONSTER_ID_BLACKTONGUE              = 70,
/** MONSTER_ID_DEATH_WING*/
    UNIQUE_MONSTER_ID_VILETOUCH                = 71,
/** MONSTER_ID_FIRE_DRAKE*/
    UNIQUE_MONSTER_ID_VIPERFLAME               = 72,
/** MONSTER_ID_GOLD_VIPER*/
    UNIQUE_MONSTER_ID_FANGSKIN                 = 73,
/** MONSTER_ID_SUCCUBUS*/
    UNIQUE_MONSTER_ID_WITCHFIRE_THE_UNHOLY     = 74,
/** MONSTER_ID_BALROG*/
    UNIQUE_MONSTER_ID_BLACKSKULL               = 75,
/** MONSTER_ID_UNRAVELER*/
    UNIQUE_MONSTER_ID_SOULSLASH                = 76,
/** MONSTER_ID_VORTEX_LORD*/
    UNIQUE_MONSTER_ID_WINDSPAWN                = 77,
/** MONSTER_ID_AZURE_DRAKE*/
    UNIQUE_MONSTER_ID_LORD_OF_THE_PIT          = 78,
/** MONSTER_ID_DOOM_GUARD*/
    UNIQUE_MONSTER_ID_RUSTWEAVER               = 79,
/** MONSTER_ID_HOLLOW_ONE*/
    UNIQUE_MONSTER_ID_HOWLINGIRE_THE_SHADE     = 80,
/** MONSTER_ID_MAELSTORM*/
    UNIQUE_MONSTER_ID_DOOMCLOUD                = 81,
/** MONSTER_ID_PAIN_MASTER*/
    UNIQUE_MONSTER_ID_BLOODMOON_SOULFIRE       = 82,
/** MONSTER_ID_SNOW_WITCH*/
    UNIQUE_MONSTER_ID_WITCHMOON                = 83,
/** MONSTER_ID_VORTEX_LORD*/
    UNIQUE_MONSTER_ID_GOREFEAST                = 84,
/** MONSTER_ID_DOOM_GUARD*/
    UNIQUE_MONSTER_ID_GRAYWAR_THE_SLAYER       = 85,
/** MONSTER_ID_MAGISTRATE*/
    UNIQUE_MONSTER_ID_DREADJUDGE               = 86,
/** MONSTER_ID_HELL_SPAWN*/
    UNIQUE_MONSTER_ID_STAREYE_THE_WITCH        = 87,
/** MONSTER_ID_STEEL_LORD*/
    UNIQUE_MONSTER_ID_STEELSKULL_THE_HUNTER    = 88,
/** MONSTER_ID_BLOOD_KNIGHT*/
    UNIQUE_MONSTER_ID_SIR_GORASH               = 89,
/** MONSTER_ID_CABALIST*/
    UNIQUE_MONSTER_ID_THE_VIZIER               = 90,
/** MONSTER_ID_REALITY_WEAVER*/
    UNIQUE_MONSTER_ID_ZAMPHIR                  = 91,
/** MONSTER_ID_HELL_SPAWN*/
    UNIQUE_MONSTER_ID_BLOODLUST                = 92,
/** MONSTER_ID_HELL_SPAWN*/
    UNIQUE_MONSTER_ID_WEBWIDOW                 = 93,
/** MONSTER_ID_SOUL_BURNER*/
    UNIQUE_MONSTER_ID_FLESHDANCER              = 94,
/** MONSTER_ID_OBSIDIAN_LORD*/
    UNIQUE_MONSTER_ID_GRIMSPIKE                = 95,
/** MONSTER_ID_STORM_LORD*/
    UNIQUE_MONSTER_ID_DOOMLOCK                 = 96,
/** MONSTER_ID_NONE*/
    UNIQUE_MONSTER_ID_NULL                     = 97,
} unique_monster_id;
